...
YOLO_MODEL_PATH = Config.get_yolo_model_path()
DEFAULT_CONFIDENCE_THRESHOLD = Config.get_default_confidence_threshold()
DEFAULT_IOU_THRESHOLD = Config.get_default_iou_threshold()
SCREENSHOTS_DIR = str(Config.get_screenshots_dir())
